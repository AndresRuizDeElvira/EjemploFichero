...
public class DowloadEpubFile extends AsyncTask<Void, Long, Boolean>  {
	    ...
	    @SuppressWarnings("deprecation")
	     void DownloadEpubFile(Context context, DropboxAPI<?> api,
	            String dropboxPath, ImageView view,String pathImagen, String nombreFichero,long longitudFichero,int ix)
	    {
             ...
             System.out.println("nUEVO 1111111");
	    ...
	    protected Boolean doInBackground(Void... params) {
	        try {
	           ...
	           cachePath = mContext.getFilesDir().getAbsolutePath() + "/" + NombreFicheroImagen;
	            ...
	            mApi.getFile(pathImagen, null, mFos, null);
	            if (mCanceled) {
	                return false;
	            }
	            return true;
